...
# Plugin metadata
plugin_metadata("config_service", version="1.0.0",
...
def ksi_handle_event(event_name: str, data: Dict[str, Any], context: Dict[str, Any]):
    """Handle config-related events using decorated handlers."""
...
@event_handler("config:get", data_type=ConfigGetData)
def handle_get(data: ConfigGetData) -> Dict[str, Any]:
    """
...
@event_handler("config:set", data_type=ConfigSetData)
def handle_set(data: ConfigSetData) -> Dict[str, Any]:
    """
...
@event_handler("config:validate", data_type=ConfigValidateData)
def handle_validate(data: ConfigValidateData) -> Dict[str, Any]:
    """
...
@event_handler("config:reload", data_type=ConfigReloadData)
def handle_reload(data: ConfigReloadData) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if component in ["daemon", "all"] and emit_event:
            emit_event("daemon:config_reload", {})
            results["reloaded"].append("daemon")
        
        if component in ["plugins", "all"] and emit_event:
            emit_event("plugins:reload", {})
            results["reloaded"].append("plugins")
        
        if component in ["compositions", "all"] and emit_event:
            emit_event("composition:reload", {})
...
@event_handler("config:backup", data_type=ConfigBackupData)
def handle_backup(data: ConfigBackupData) -> Dict[str, Any]:
    """
...
@event_handler("config:rollback", data_type=ConfigRollbackData)
def handle_rollback(data: ConfigRollbackData) -> Dict[str, Any]:
    """
