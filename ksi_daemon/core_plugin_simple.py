...
from .simple_event_router import SimpleEventRouter
...
class SimpleDaemonCore:
    ...
    async def initialize(self) -> None:
        ...
        # Call startup hooks
        startup_results = self.plugin_loader.plugin_manager.hook.ksi_startup(
    ...
    async def shutdown(self) -> None:
        ...
        try:
            # Call shutdown hooks
            shutdown_results = self.plugin_loader.plugin_manager.hook.ksi_shutdown()
