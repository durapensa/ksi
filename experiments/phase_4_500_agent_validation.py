#!/usr/bin/env python3
"""
Phase 4: 500-Agent Scale Validation
Confirming fairness emergence at larger scale with enhanced analysis.
"""
...
class HundredAgentEcosystem:
    ...
    def simulate_trading_round(self, round_num: int):
        ...
        for i in range(0, min(len(shuffled)-1, 200), 2):  # Scale up to 100 pairs per round
            agent_a = shuffled[i]
    ...
    def run_experiment(self, num_rounds=50):
        ...
        print("\n" + "="*60)
        print(f"🚀 PHASE 4: {self.num_agents}-AGENT SCALE VALIDATION")
        print("="*60)
...
if __name__ == "__main__":
    ...
    # Configuration - SCALE VALIDATION
    NUM_AGENTS = 500  # Testing at 5x scale
    NUM_ROUNDS = 100  # More rounds for stability analysis
    
    # Run experiment
    print(f"\n🚀 Starting Phase 4 SCALE VALIDATION with {NUM_AGENTS} agents...")
    print("This will test if fairness emergence holds at larger scale")
    ...
    try:
        ...
        # Save results
        results_file = Path("experiments/results/phase_4_scale_validation_results.json")
        results_file.parent.mkdir(parents=True, exist_ok=True)
        
        # Convert to serializable format
        save_data = {
            "timestamp": datetime.now().isoformat(),
            "experiment": "phase_4_500_agent_scale_validation",
