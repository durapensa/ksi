...
echo "  tail -f var/logs/daemon/daemon.log.jsonl | grep -E '($TOURNAMENT_ID|tournament_evaluation|match.*complete)'"
echo ""
echo "Check evaluation responses:"
echo "  grep 'tournament:evaluation_response' var/logs/daemon/daemon.log.jsonl | tail"
echo ""
